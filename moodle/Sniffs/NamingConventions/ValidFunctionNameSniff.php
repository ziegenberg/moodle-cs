...
class ValidFunctionNameSniff extends AbstractScopeSniff
{
    ...
    protected function processTokenWithinScope(File $phpcsfile, $stackptr, $currscope) {
        ...
        // As of PHPCS 4.0 T_ANON_CLASS is part of the OO scope tokens, but anonymous
        // classes have no name and therefore the class name cannot (and need not) be checked.
